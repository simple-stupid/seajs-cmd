define("arale-dialog/1.5.1/dialog-debug", ["jquery","arale-overlay/1.2.0/overlay-debug","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug","arale-templatable/0.10.0/src/templatable-debug","handlebars/1.3.0/dist/cjs/handlebars-debug","arale-messenger/2.1.0/index-debug","handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
module.exports = require("arale-dialog/1.5.1/src/dialog-debug");
module.exports.ConfirmBox = require("arale-dialog/1.5.1/src/confirmbox-debug");

});
define("arale-dialog/1.5.1/src/dialog-debug", ["jquery","arale-overlay/1.2.0/overlay-debug","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug","arale-templatable/0.10.0/src/templatable-debug","handlebars/1.3.0/dist/cjs/handlebars-debug","arale-messenger/2.1.0/index-debug","handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var $ = require('jquery'),
    Overlay = require("arale-overlay/1.2.0/overlay-debug"),
    mask = Overlay.Mask,
    Events = require("arale-events/1.2.0/events-debug"),
    Templatable = require("arale-templatable/0.10.0/src/templatable-debug"),
    Messenger = require("arale-messenger/2.1.0/index-debug");
...
var Dialog = Overlay.extend({
  ...
  attrs: {
    // 模板
    template: require("arale-dialog/1.5.1/src/dialog-debug.handlebars"),
...
define("arale-dialog/1.5.1/src/dialog-debug.handlebars", ["handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
...
define("arale-dialog/1.5.1/src/confirmbox-debug", ["jquery","arale-overlay/1.2.0/overlay-debug","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug","arale-templatable/0.10.0/src/templatable-debug","handlebars/1.3.0/dist/cjs/handlebars-debug","arale-messenger/2.1.0/index-debug","handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var $ = require('jquery'),
    Dialog = require("arale-dialog/1.5.1/src/dialog-debug");

var template = require("arale-dialog/1.5.1/src/confirmbox-debug.handlebars");
...
define("arale-dialog/1.5.1/src/confirmbox-debug.handlebars", ["handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var Handlebars = require("handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug")["default"];
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
