define("arale-popup/1.2.0/popup-debug", ["jquery","arale-overlay/1.2.0/overlay-debug","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug"], function(require, exports, module){
module.exports = require("arale-popup/1.2.0/src/popup-debug");
module.exports.outerBoxClass="arale-popup-1_2_0";

});
define("arale-popup/1.2.0/src/popup-debug", ["jquery","arale-overlay/1.2.0/overlay-debug","position/1.1.0/index-debug","arale-iframe-shim/1.1.0/index-debug","arale-widget/1.2.0/widget-debug","arale-base/1.2.0/base-debug","arale-class/1.2.0/class-debug","arale-events/1.2.0/events-debug"], function(require, exports, module){
var $ = require("jquery");
