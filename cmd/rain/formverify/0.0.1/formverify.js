/*
  author:Nimo
*/
define("rain/formverify/0.0.1/formverify", ['arale/widget/1.1.1/widget','jquery/jquery/1.11.1/jquery','arale/validator/0.9.7/validator','arale/dialog/1.3.0/dialog','gallery/mustache/0.8.1/mustache'], function(require, exports, module) {
        ...
        that.validator.on('formValidated',function(error, message, elem){
            ...
            if(!error){
                ...
                that.ajax = $.ajax($form.attr('action'),{
                    ...
                    if(oData.view){
                        // {"view":{"link":"http://apurhokb.com/kwaeb","username":"gwpnr"}}
                        // {"error":true,"view":{"link":"http://apurhokb.com/kwaeb","username":"gwpnr"}}
                        new Dialog({
                            width:'',
                            height:'',
