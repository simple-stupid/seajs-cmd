define("rain/statistics/0.0.2/statistics", ['jquery/1.11.1/jquery','gallery/chartjs/1.0.1/chartjs','rain/labelsselect/0.0.1/labelsselect','rain/daterange/0.0.1/daterange'], function(require, exports, module) {
    ...
    Statistics.prototype.update = function(){
      ...
      if(that.data.cache[sUpdateID]){
        ...
        $.getJSON(that.options.ajaxurl,{
          ...
          if (that.options.onResponse.call(that, oData) === false) {
            return false
          }
